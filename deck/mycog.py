...
, "**Gemme** me pas d'idée pour la blague", "J'ai plus d'idée donc je vais utiliser mon **joker**", "Vous avez gagné un bon pour un **voyage astral à sens unique**"
...
liste4 = " Lag : vous perdez vos deux prochains tours"
