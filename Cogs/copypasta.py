...
class CopyPasta(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.answers = ["""Au fait, tu as déjà joué Final Fantasy XIV, 
                        le MMORPG critiquement acclamé avec un essai gratuit sans limite de temps te permettant d'aller jusqu'au niveau 60,
                        et qui inclut la première expansion, Heavensward, qui a gagné de multiples awards ?""", "Oui mais non",
                        "UwU", ":3", "Tu veux tirer une carte ?"]
